    ...
    <div className="app-container">
      ...
      <div className="app-content">
        <div className="app-content-header">
          <h1 className="app-content-headerText">Customer</h1>
          ...
          <button className="app-content-headerButton">Update Customer</button>
        </div>
            ...
            <div className="products-row" key={0}>
              ...
              <div className="product-cell price">
                ...
                <a href="#" style={{ color: "white" }}>
                  view orders({responseData.orders.length})
                </a>
              </div>
              <div className="product-cell stock">
                <span className="cell-label"></span>
                <Link
                  to={`/maps/${responseData.geofence_areas.loc_lat}/${responseData.geofence_areas.loc_lon}`}
                  target="_blank"
                >
                  <div
                    style={{
